...
前回立直の利点と欠点を挙げましたが、圧倒的にメリットの方が大きく、**「听牌したら立直するのが基本」**と思って差し支えありません。

ヤミテンを選択するケースの方がレアです。

したがって、ヤミテン有利のケースを覚えておいて

該当しない場面では、迷わず立直を打つようにするのが良いでしょう。

判断这是真话还是谎言有两点。

手牌和情况。 （麻将中的所有决定都是基于这两个因素做出的。）

**手板**：根据手板材质判断，如手板的扣板、圆点等。

**情况**：根据当前积分、其他玩家动向、轮次等判断。
...
最明显的最好使用默听的例子是 Yakuman，如例 1 所示。

重新站起来并不会增加你的分数，因此没有理由重新站起来。

唯一的例外是 Tsumori Shiankoku，您可以从中恢复。
...
肯定是不要再复出《雷骑》中的双男一角了。双满和三满之间相差3个粉丝，即使我们努力恢复，也不太可能达到三满。即使对于亚美天来说，这也将是决定性的一击。站起来降低获胜概率，显然是一种损失。

上面是一个极端的例子，但笨形大招应该是针对亚美天的。特别是，Somete可能会对废弃的牌保持警惕，因此Yamiten将具有优势。

マンガン以下の手であれば、立直をかけると確実に得点上昇が望めます。しかしマンガンを超えると、１ファンアップしても得点が変わらない、ということがありえます。

如果你在Yamiten中有比Haneman更多的动作，那么即使你有双方，也不使用站立是有利的。

锰是判断复苏的转折点，默吘在琼点。

这是一个灰色地带，双方都没有优势。

**如果早期状态良好，反弹是一个优势**是目前的观点。
