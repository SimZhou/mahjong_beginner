...
这是最常见的“剩下两组两面搭子”的一向听。  
这种手牌通过保留双碰受入，可以扩大听牌机会。
...
如果保留索子的延单形，当然也还有转向一气通贯的空间；  
但就算把打点考虑进去，我也不认为那是更划算的打法。

如果双碰受入那几张后来变薄了，再把它们转作[安全牌](../mamori/mamori02.md)也可以。
...
切 <img src="../hai/pin2.gif" width="24" height="34" /> 和切 <img src="../hai/sou5.gif" width="24" height="34" />，两边进听牌的受入同为 `23` 张。  
既然如此，就比较听牌时的待牌。
...
靠保底的双碰受入进听牌时，如果是切 <img src="../hai/sou5.gif" width="24" height="34" />，最终会形成三面张。  
差距虽然不大，但这是实战里很常出现的形，最好练到能机械处理。
...
切 <img src="../hai/man2.gif" width="24" height="34" /> 和切 <img src="../hai/pin5.gif" width="24" height="34" /> 都是 `15` 张，  
但和例 2 一样，靠双碰受入进听牌时，切 <img src="../hai/pin5.gif" width="24" height="34" /> 会形成两面，所以更有利。

凭感觉，大概也知道切 <img src="../hai/man2.gif" width="24" height="34" /> 不对；  
但实际上很多初学者会切 <img src="../hai/man4.gif" width="24" height="34" />。  
这条也应当当成理论记住。

### 理论小结

<span class="green">双碰受入留在较弱的搭子一侧，会更宽。</span>
...
这是包含变则三面张可能性的手牌。  
保留边张受入那边，枚数会多 `1` 张，而且在手役和守备上也更有利。
...
如果只看受入枚数，切 <img src="../hai/man6.gif" width="24" height="34" /> 会多 `1` 张。  
但只差 1 张左右时，就想优先看好形变化的丰富程度，因此这里想切 <img src="../hai/man8.gif" width="24" height="34" />。  
像下面这样让筒子伸展，是更理想的。  
比起两嵌，双碰果然还是更柔软的形。
...
<span class="green">只差 1 到 2 张左右时，也会优先考虑好形变化的丰富程度，以及听牌时待牌的好坏。</span>
...
这两种形在受入枚数和最终待牌上都没有差别，所以要比手役。

例 7 如果摸进 <img src="../hai/pin2.gif" width="24" height="34" />，还能去看平和和三色，  
因此切 <img src="../hai/pin3.gif" width="24" height="34" /> 更优。
...
例 8 是平和不成立的形，所以带有一杯口的一边更优。  
因此切 <img src="../hai/pin1.gif" width="24" height="34" />。  
另外，摸 <img src="../hai/pin5.gif" width="24" height="34" /> 之后还能把手牌做得更宽，这也是一点小优势。
...
顺手就把 <img src="../hai/sou8.gif" width="24" height="34" /> 打掉，可不太好。  
这里去看两杯口是坏手。

因为还保留着坎 <img src="../hai/sou7.gif" width="24" height="34" /> 的受入，所以这里应切 <img src="../hai/pin8.gif" width="24" height="34" />。

前面在比较受入枚数时，都是把所有能让你听牌的牌完整列出来；  
但实战里真的去比较时，其实没必要把重叠的受入也一起算。  
更重要的是迅速找出会产生差异的那部分受入。
