...
alt_lang_url: https://simzhou.com/riichi_mahjong_book/en/kihon/kihon03.html
---

# 听牌与向听

这里开始学习麻将做牌时的重要概念。
比起手役，更重要的是先学会用“牌形”来看手牌。

## 麻将的和牌形

麻将不用说，当然是一种以完成和牌形为目标的游戏。
而这种和牌形，大致可以分成 3 种。
...
其中（2）和（3）是特殊和牌形，基本还是（1）这种四面子形。
而面子又分成刻子和顺子两种。

【顺子】<img src="../hai/man6.gif" width="24" height="34"><img src="../hai/man7.gif" width="24" height="34"><img src="../hai/man8.gif" width="24" height="34">　<img src="../hai/sou2.gif" width="24" height="34"><img src="../hai/sou3.gif" width="24" height="34"><img src="../hai/sou4.gif" width="24" height="34">　……　连续的 3 张牌
...
另外，严格来说面子里还包括四张相同牌组成的杠子，
不过这里先不和刻子做区分。

## 听牌是什么

只差 1 张牌就能完成和牌形，这种状态就叫听牌。
只要有役，就可以和牌。
...
这是摸到 <img src="../hai/man1.gif" width="24" height="34"> 或 <img src="../hai/man4.gif" width="24" height="34"> 就能和牌的形。

麻将里，如果不听牌，就不可能拿到分数。（例外只有别人错和）
而且如果是门清，也就是一张都没鸣的状态，还可以宣言立直。
因此，尽可能快地把手牌推进到听牌，非常重要。
...
这是距离听牌还差一步的状态。
只要摸到 <img src="../hai/man1.gif" width="24" height="34"><img src="../hai/man4.gif" width="24" height="34"><img src="../hai/pin6.gif" width="24" height="34">，就能听牌。

像这样，只要再摸进 1 张有效牌就能听牌的状态，
就叫作 **一向听**。

而这些能让手牌进入听牌的受入（这里就是 <img src="../hai/man1.gif" width="24" height="34"><img src="../hai/man4.gif" width="24" height="34"><img src="../hai/pin6.gif" width="24" height="34">），
原文把它叫作 **“听牌机会”**。
...
例 3 的受入枚数非常多，是 `13` 种 `42` 枚的一向听。

而例 2 只有 `3` 种 `12` 枚，差了将近 4 倍。

像这样，同样都是一向听，因牌的组合不同，听牌难易度会出现很大的差别。

距离听牌最少还要几步，这个最小次数就叫作 **向听数**。
...
例 4 就是六向听的例子，就算按最快的七对子听牌路线走，也还要六步。

向听数是判断离和牌还要多久的重要指标，是非常重要的想法。
要训练到能够凭感觉判断自己现在是几向听。
至少，一向听和二向听必须明确地区分开来打。

## 降低向听数

如果自己的手牌是二向听，就以一向听为目标；
如果是一向听，就以听牌为目标；
如果已经听牌，就以和牌为目标。
带着这种想法去打牌，非常重要。
...
例如这手里，如果只是因为“靠边”“浮着”就切掉 <img src="../hai/man1.gif" width="24" height="34">，手牌仍然还是二向听。
...
中途绝不可能跳过某一级。
当然，有时也会出现不降低向听数反而更好的情况，
但基本上还是应该以降低向听数为前提来考虑打牌。
