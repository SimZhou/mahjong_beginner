...
可以看出，四重瓷砖也因为更靠近内部而更容易被接受，就像孤立的瓷砖一样。

3456和4567这两种类型是使用四块阿苏瓷砖的类型中最厚的类型。请记住这一点。
当你手上有一张牌时，计算并玩这里的两侧。

1234和6789在功能上几乎分别与隔离块4和9相同。
它的优点是容易制作麻雀头。
...
例如，用这只手<img src="../hai/man3.gif" style="display:inline; vertical-align:middle; margin:0 1px; width:24px; height:34px;" />不假思索地将四重形状固定为一个整体是错误的，就像切割一个
击球方式效率太低这么说一点也不夸张。

### 理论/总结

四重形状被广泛接受。
特别是，3456和4567是四件式复合形式，具有最高的形成两个面的能力。
...
1223 和 7889 没有被广泛接受，并且很容易印刷错误。
使用起来并不那么容易。

与孤立的瓷砖2和8相比，E-P-Co的制作很容易。
是不是penchan+kuchan形状的时候比较容易做麻雀头的优点？
（67889可以做一个麻雀头+一侧有5、6、8、9片）

2334到6778的凸出形状两边都很容易制作，
这是一个非常有用的形状。

### 理论/总结

2334、3445、4556、5667、6778 凸出形状为
这是一个很好的形状，可以让您用四种类型的瓷砖制作两侧，并且也有可能成为 e-peko。
