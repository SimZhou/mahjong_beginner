...
让我们将 Kanoko 视为面部​​候选者。

## 孩子的天性

对于东子来说，当他处于第二组时，他作为面孔候选人最有价值。有一个特点就是。
...
与实施例1相比，
接受易象奇<img src="../hai/man8.gif" style="display:inline; vertical-align:middle; margin:0 1px; width:24px; height:34px;" /><img src="../hai/pin9.gif" style="display:inline; vertical-align:middle; margin:0 1px; width:24px; height:34px;" />还有4张照片。

如果有两对或更多对
高士每组接受两张门票。
接受这些山板接收器，或者沙博斯接收器它被称为。
...
那么，当存在三组儿童时（如示例 3 所示）会发生什么？

即使你再添加一套shako，你也只会多得到两个shabo接收器。
从示例 3 来看，如果你打破了 kuchan，你将失去 4 张牌，所以
如果再增加孩子的数量，那就是不利的了。

来自示例3<img src="../hai/pin9.gif" style="display:inline; vertical-align:middle; margin:0 1px; width:24px; height:34px;" />从瓷砖上可能的答案是切割。
我们将在第 2 章中考虑最好删除哪一个。

（知道老三在这里处于劣势也没关系）

由于我们每套只接受两个 Shabo 托盘，
如果你有4张或更多牌，你手中牌的接受范围就会变窄。
因此，玩家经常使用“一辉”来推进他们的动作或瞄准七个孩子。
