...
如示例 1 所示，如果这棵树的破坏和牌和牌都被破坏了，

最好不要拿笔。

应当切<img src="../hai/sou1m.gif" style="display:inline; vertical-align:middle; margin:0 1px;" width="19" height="26"/>，这手至少也要做成断幺九后再立直。
...
显然，拿去雅曼的话，钱更容易拿到。
2、梁翔琪回归
也有一些情况，为了实现破与和牌的联系，返回相反的方向是有利的。
示例3 自摸
笔是这只手的关键。
好棋就是一刀还给梁湘琪。
...
考虑攻击的难易程度和牌打点
正确的答案不一定是“前进几个方向”。	 
在击球时保持速度和牌高度之间的平衡很重要。 
关于牌的讨论到此结束，在下一节中我们将解释屋久类型。
