...
津莫⇒ 剪切有4块，
还有4瓶香槟。如果你有同样的四张牌，玩一个更容易实现和平的游戏不是更好吗？确实，一些老策略书上说，砍伐才是正确答案。但是，当变成易象棋时，就有区别了。改变A津莫改变B津莫很明显，下面这位是更优秀的易向奇。就算变成了易象棋，也还是起到了有效的作用。我别无选择，只能放弃它。  
