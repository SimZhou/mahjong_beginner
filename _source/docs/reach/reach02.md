...
前回立直の利点と欠点を挙げましたが、圧倒的にメリットの方が大きく、**「听牌牌牌したら立直するのが基本」**と思って差し支えありません。
...
最明显的最好使用默听牌牌的例子是 Yakuman，如例 1 所示。

重新站起来并不会增加你的分数，因此没有理由重新站起来。

唯一的例外是 自摸ri Shiankoku，您可以从中恢复。
...
肯定是不要再复出《雷骑》中的双男一角了。双满和牌牌三满之间相差3个粉丝，即使我们努力恢复，也不太可能达到三满。即使对于亚美天来说，这也将是决定性的一击。站起来降低获胜概率，显然是一种损失。
