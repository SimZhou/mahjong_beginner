...
向听数是衡量自己离和牌还有多远的重要指标。  
判断一副牌该不该鸣，首先就该看向听数有没有前进。
...
这里即使碰 <img src="../hai/man3.gif" style="display:inline;vertical-align:middle;margin:0 1px;" width="24" height="34"/> 或 <img src="../hai/man4.gif" style="display:inline;vertical-align:middle;margin:0 1px;" width="24" height="34"/>，手牌也还是一向听，并没有真正前进。
...
如果是这种牌，那么上家打出 <img src="../hai/pin5.gif" style="display:inline;vertical-align:middle;margin:0 1px;" width="24" height="34"/> 时，也应该忍住不吃。

因为它的牌形实在太苦，就算鸣了，和牌率依然很低。  
这种时候不如提前保留退路，准备应对别人立直。

## 一个粗略判断标准

原文给出的经验线可以直接记：

1. 三副露：至少要听牌；如果只是一向听，那最好是满贯以上的大手，比如清一色
2. 二副露：至少一向听；如果还是两向听，那必须是相当好的形，或者至少 3900 以上的打点价值

照这个标准去约束自己的仕挂，鸣牌质量会高很多。
...
这手如果去鸣 <img src="../hai/sou4.gif" style="display:inline;vertical-align:middle;margin:0 1px;" width="24" height="34"/> 或 <img src="../hai/sou7.gif" style="display:inline;vertical-align:middle;margin:0 1px;" width="24" height="34"/>，鸣完以后依然还是两向听，而且牌也不贵。

这就不能算合理的仕挂。

相比之下，如果是坎 <img src="../hai/pin8.gif" style="display:inline;vertical-align:middle;margin:0 1px;" width="24" height="34"/>，那还勉强可以考虑。
