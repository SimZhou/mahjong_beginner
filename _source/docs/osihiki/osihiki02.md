...
即使你犯了错误，也不应该剪切 <img src="../hai/pin6m.gif" style="display:inline;vertical-align:middle; margin:0 1px;" width="19" height="26"/> 减少一些，以免出现深色雕刻牌。
...
另一方面，根据招数的类型和牌使用的宝藏牌的数量来确定对手的分数并不是那么困难。
理论/总结

有了招数，就很容易看出对手的击球点，因此预估的击球点就可以作为进攻和牌防守决策的依据。 
复苏存在诸多不确定性，因此
除涉及一人等特殊情况外，重点关注对方是父母还是孩子。
奥里成功概率
这是决定进攻和牌防守决策的一个非常重要的因素。
没有任何实际的牌，也没有多少牌看起来会通过。 
在这种情况下，通常的方法是直接玩。 
