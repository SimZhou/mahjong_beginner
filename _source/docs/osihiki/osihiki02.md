...
风险程度不一定需要高水平的阅读能力。
在示例4中，可以粗略地估计风险程度。
既然穿过了，那就只能打到山国或者单骑者了。 
风险低，可以这样切瓷砖。
我不知道从现在开始我是否会继续坚持下去。
至少现在还不是做决定的时候。
对手的估计打点
当然，最好不要选择高价的单打，但从丢弃的牌中猜测对手的分数是极其困难的。除了明显的萨梅特站立之外，这是不现实的。
重要的是对方是父母还是孩子。 
得分为 1.5 倍的父母仍然是一个威胁。
另外，很容易判断底切站立位置是高击球点。
实施例5
　　
有些人会不小心地攻击这种站立式的棋子，但考虑到浦保牌有两种类型，如果击中它，你会失去很多分数，所以除非是严重的棋步，否则你应该避免游戏。
然而，由于很难在直线上读取打点点，因此猜测打点点因有噱头而更为重要。即使您可以看到桌子上的宝藏牌，您也可能会使用红色或乌拉宝藏牌获得高分，并且读取分数的可靠性会很低。
另一方面，根据招数的类型和使用的宝藏牌的数量来确定对手的分数并不是那么困难。
理论/总结

有了招数，就很容易看出对手的击球点，因此预估的击球点就可以作为进攻和防守决策的依据。 
复苏存在诸多不确定性，因此
除涉及一人等特殊情况外，重点关注对方是父母还是孩子。
奥里成功概率
这是决定进攻和防守决策的一个非常重要的因素。
没有任何实际的瓷砖，也没有多少瓷砖看起来会通过。 
在这种情况下，通常的方法是直接玩。 
然而，如果我们能得到一些实际的物品，故事就会有所不同。
实施例6
重新站起来
手牌、一骑通、宝牌
比如你玩这手牌就完全没有问题。 
...
虽然不能说比它危险得多
这难道不是Ori的转折点吗？
这是一个我不想推动太多的举动，因为它本来就是1000点。 
有了三块安全牌，赢得比赛的机会就增加了。 
因此，我认为此时撤退是一个很好的进攻或防守决定。
我认为以上五点是做出进攻和防守决策的基本要素。 
当然，一旦进入南场，比分形势就变得更加重要。
稍后我将将此视为进攻和防守判断的应用。
首先，你如何根据这些材料做出决定？
