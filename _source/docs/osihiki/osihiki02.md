...
另一方面，根据招数的类型和牌牌使用的宝藏牌的数量来确定对手的分数并不是那么困难。
理论/总结

有了招数，就很容易看出对手的击球点，因此预估的击球点就可以作为进攻和牌牌防守决策的依据。 
复苏存在诸多不确定性，因此
除涉及一人等特殊情况外，重点关注对方是父母还是孩子。
奥里成功概率
这是决定进攻和牌牌防守决策的一个非常重要的因素。
...
我认为以上五点是做出进攻和牌牌防守决策的基本要素。 
当然，一旦进入南场，比分形势就变得更加重要。
稍后我将将此视为进攻和牌牌防守判断的应用。
首先，你如何根据这些材料做出决定？
