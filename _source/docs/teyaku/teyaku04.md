...
平和は全てシュンツで構成され、かつ最終的な听が両面でなくてはいけません。

両面をつくっていくことが、平和手作りのポイントです。
...
ピンズは <img src="/hai/pin5.gif" style="display:inline; vertical-align:middle; margin:0 1px;" width="24" height="34"/> を引けば両面になり、平和が確定します。
...
<img src="/hai/pin4.gif" style="display:inline;vertical-align:middle;margin:0 1px;" width="24" height="34"/> 切割更容易达成和平，因此在积分上是有利的。

## 3.大俊俊子

如果麻雀头是瓦，你就不会得到平安，所以要小心。
...
このように、对子落としで平和を狙うというのはよくあるので覚えておくこと。
